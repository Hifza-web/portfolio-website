          ...
          <div className="grid grid-cols-1 gap-8 sm:gap-10 lg:grid-cols-2 lg:gap-12">
            ...
            <div>
              ...
              <div className="mt-6 sm:mt-8">
                <button className="rounded-full bg-[#00ABF0] px-8 py-3 text-sm font-semibold text-white transition-all duration-300 hover:bg-[#0095d4] hover:shadow-[0_0_20px_#00ABF0] sm:text-base">
                  Send Message
                </button>
              </div>
            </div>
            ...
            <div className="flex flex-col justify-center text-white">
              ...
              <div className="mb-7 sm:mb-8">
                <h3 className="text-xl font-bold text-[#00ABF0] sm:text-2xl lg:text-3xl">Mobile</h3>
              ...
              {/* Email */}
              <div className="mb-7 sm:mb-8">
                <h3 className="text-xl font-bold text-[#00ABF0] sm:text-2xl lg:text-3xl">Email</h3>

                <div className="mt-2 flex items-center gap-3 sm:mt-3">
                  <FaEnvelope className="text-lg text-[#00ABF0] sm:text-xl" />
                  <span className="break-all text-base sm:break-normal sm:text-lg">hifzanazar@gmail.com</span>
                </div>
              </div>

              {/* Location */}
              <div className="mb-7 sm:mb-8">
                <h3 className="text-xl font-bold text-[#00ABF0] sm:text-2xl lg:text-3xl">Location</h3>
